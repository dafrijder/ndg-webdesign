    ...
    <section class="min-h-screen bg-[#111823] flex items-center justify-center px-4">
        <div class="w-full max-w-2xl bg-[#1b2340] border border-blue-500 rounded-3xl p-8 shadow-2xl">
            ...
            <form action="{{ route('admin.blog.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    <label class="block text-blue-200 mb-1">Title</label>
                    <input type="text" name="title"
                        class="w-full bg-[#111823] border border-blue-500 rounded-xl px-4 py-2 text-blue-100 focus:ring-2 focus:ring-blue-500 outline-none"
                        required>
                </div>

                <div>
                    <label class="block text-blue-200 mb-1">Message</label>
